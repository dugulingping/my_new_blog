---
title: "一言API使用指南"
description: "为什么会突然搞一个一言的API呢？ 原因是前几天的一个梦，我收到一份礼物，是一封信。拆开是两张很精致的纸，其中一张写了大大大大的I hate U.另一张用蝇头小楷写满了I miss U. 于是就有了这个! 一言API 1 好像扯远了，下面开..."
pubDate: "2018-05-03"
createdAt: "2018-05-03 10:19:00"
tags:
  - "code"
updatedDate: "2018-05-06"
updatedAt: "2018-05-06 17:54:40"
---

{/* migrated from Typecho: cid=17 | slug=Hitokoto-Help | source-categories=code | merged-tags=code */}
...
>#####调用官方库示例：<br />https://api.icyuyan.net/hitokoto/?type=txt
>#####调用私人库示例（此示例无返回则无此用户）：<br />https://api.icyuyan.net/hitokoto/?type=txt&user=YourUserName
>#####添加条目示例：<br />https://api.icyuyan.net/index.php?user=YourUser&passwd=YourPassword&data=ILOVEU
